...
export default function populateLayers(view) {
    ...
    // Enable unavailable layers 
    if ((!poverty_layers.includes(current_layer)) && (!population_layers.includes(current_layer))){
        document.getElementById('unavailable-layer').style.display = "flex";
    }
