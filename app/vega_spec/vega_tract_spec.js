const vega_tract_spec = 
{
  ...
  "data": [
    {
      "name": "tract",
      "url": "../data/tract_geo_data.1000000.topojson",
      "format": {"type": "topojson","feature": "tract_geo_data"},
      "transform": [
        {
          "type": "formula",
          "as": "selected_layer",
  ...
  "scales": [
    {
      "name": "color",
      "type": "quantize",
      "domain": {"data": "tract","field": "selected_layer"},
